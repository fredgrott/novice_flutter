...
import 'package:valueobjects_base/src/domain/failures/failure_exception.codegen.dart';


/// ErrorObject class for wanrings via the UI
/// 
...
class ErrorObject extends Equatable {
  ...
  static ErrorObject mapFailureToErrorObject({required FailureException failure}) {
    return failure.when(
